...
<body>
            ...
            <div id="navigation" class="collapse navbar-collapse flex-column">
                ...
                <ul class="navbar-nav flex-column text-left">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href=""><i class="fas fa-user fa-fw mr-2"></i>Profile</a>
                    </li>
                </ul>
    ...
    <div class="main-wrapper">
        <section class="cta-section theme-bg-light py-5">
            <div class="container text-center">
                ...
                <form method="GET" action="./" class="signup-form form-inline justify-content-center pt-3">
                    <table>
                        <tr>
                            <td> <?php echo "<a href='edit?id=$id' class='btn btn-primary'>Edit profile</a>" ?></td>
                        </tr>
                    </table><br>
        ...
        <section class="blog-list px-3 py-5 p-md-5">
            <div class="container">
                <h3 style=color:mediumpurple> Your Articles </h3>
                <?php foreach ($res as $article) : ?>
                    <div class="item mb-5">
                        <div class="media">
                            <!-- <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="assets/images/blog/blog-post-thumb-1.jpg" alt="image"> -->
                            <div class="media-body">
                                <?php $pid = $article['post_id']; ?>
                                <h3 class="title mb-1"><a href='./post?id=<?= $article['post_id'] ?>'><?= $article['title'] ?></a></h3> <?php echo "<a href='../post/edit?id=$pid' class = 'link'> Edit </a>" ?>
