...
if (isset($_POST['submitButton'])) {
    ...
    if ($msg == "Data is valid.") {
        ...
        require('conn.php');
        $query = "INSERT INTO `users` (`user_id`, `username`, `pwd`, `email`, `role`, `regisdate`) VALUES (NULL, '$lengU', '$p', '$lengE', 'basic', CURDATE());";

        mysqli_query($conn, $query) or die("kys pt 2");
        $_SESSION['username'] = $lengU;
...
<link href="bootstrap/assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="bootstrap/sign-in/sign-in.css" rel="stylesheet">
  </head>
...
<main class="form-signin w-100 m-auto">
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
    <center>
    <img class="mb-4" src="assets/images/vinyl.png" alt="" width="140" height="140">

    <h1 class="h3 mb-3 fw-normal">Register</h1>
    </center>
    <div class="form-floating">
      <input name = 'user' type="text" class="form-control" id="floatingInput" placeholder="username">
    ...
    <button name = 'submitButton' class="btn btn-primary w-100 py-2" style=  "background-color: rgb(130, 128, 237)" type="submit">Register</button>
  </form> <?php
  if (isset($_POST['submitButton'])) {
            echo $msg;
        }
